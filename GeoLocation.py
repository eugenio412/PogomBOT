...
if __name__ == '__main__':
    ...
    # Test bounding box
    location_I = GeoLocation.from_degrees(47.390967, 8.539018)
    distance = 3  # 1 kilometer
    rat = distance/6378.1
    SW_loc, NE_loc = location_I.bounding_locations(distance)
    print(location_I.distance_to(SW_loc))
    print(location_I.distance_to(NE_loc))